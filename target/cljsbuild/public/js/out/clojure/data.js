...
return cljs.core.reduce.call(null,(function (result,p__30045){
...
var vec__30049 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__30049,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__30049,(1),null);
var ab = cljs.core.nth.call(null,vec__30049,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_30055 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_30055.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_30056 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_30056.call(null,a,b);
}
});
...
return (function (){var G__30060 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30060__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1590594095064
