...
return (new CustomEvent(event_name,(function (){var obj35479 = ({"detail":data});
return obj35479;
})()));
} else {
...
var f = (function (){var pred__35486 = cljs.core._EQ_;
var expr__35487 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35486.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35487))){
return (function (p1__35480_SHARP_){
return console.warn(p1__35480_SHARP_);
});
} else {
if(cljs.core.truth_(pred__35486.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35487))){
return (function (p1__35481_SHARP_){
return console.debug(p1__35481_SHARP_);
});
} else {
if(cljs.core.truth_(pred__35486.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35487))){
return (function (p1__35482_SHARP_){
return console.error(p1__35482_SHARP_);
});
} else {
return (function (p1__35483_SHARP_){
return console.log(p1__35483_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35490){
var map__35491 = p__35490;
var map__35491__$1 = (((((!((map__35491 == null))))?(((((map__35491.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35491.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35491):map__35491);
var opts = map__35491__$1;
var eval_fn = cljs.core.get.call(null,map__35491__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__35493_SHARP_){
return new_def.callback(p1__35493_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__35494){
var vec__35495 = p__35494;
var ky = cljs.core.nth.call(null,vec__35495,(0),null);
var v = cljs.core.nth.call(null,vec__35495,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1590594102077
