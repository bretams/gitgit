...
var o28598 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28598["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28599 = temp__5733__auto____$1;
return (o28599["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__27956__auto___28602 = t;
(o__27956__auto___28602["cljs$lang$ctorPrWriter"]).call(o__27956__auto___28602,t,writer);
}catch (e28601){var __28603 = e28601;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28604 = num_code;
switch (G__28604) {
case (1):
return (185);
...
}catch (e28606){var _e__27963__auto__ = e28606;
return false;
}})())){
...
var vec__28607 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28607,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28610 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28610["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28611 = temp__5733__auto____$1;
return (o28611["nameToPath"]);
} else {
return null;
}
} else {
...
var ns_detector = cljs.core.nth.call(null,vec__28615,(0),null);
...
var G__28621 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28622 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28621;
remaining_tokens = G__28622;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28612){
var G__28613 = cljs.core.first.call(null,seq28612);
var seq28612__$1 = cljs.core.next.call(null,seq28612);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28613,seq28612__$1);
}));
...
var vec__28626 = cljs.core.split_with.call(null,(function (p1__28625_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28625_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28626,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28626,(1),null);
...
var vec__28632 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28632,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28632,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28635 = cljs.core.rest.call(null,remaining_tokens);
var G__28636 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28635;
name_tokens = G__28636;
continue;
} else {
...
var vec__28639 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28639,(0),null);
var arity = cljs.core.nth.call(null,vec__28639,(1),null);
var vec__28642 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28642,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28642,(1),null);
var vec__28645 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28645,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28645,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28645,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28645,(3),null);
...
var vec__28651 = result;
var munged_ns = cljs.core.nth.call(null,vec__28651,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28651,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28651,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28651,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28651,(4),null);
var arity = cljs.core.nth.call(null,vec__28651,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28655 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__28655,(0),null);
var args = cljs.core.nth.call(null,vec__28655,(1),null);
var vec__28658 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28658,(0),null);
var name = cljs.core.nth.call(null,vec__28658,(1),null);
...
var G__28661 = (arity + (1));
var G__28662 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28663){
var vec__28664 = p__28663;
var arity = cljs.core.nth.call(null,vec__28664,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28664,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28667_SHARP_){
return cljs.core.get.call(null,arities,p1__28667_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__28668_SHARP_){
return cljs.core.drop.call(null,(2),p1__28668_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___28675 = arguments.length;
var i__4737__auto___28676 = (0);
while(true){
if((i__4737__auto___28676 < len__4736__auto___28675)){
args__4742__auto__.push((arguments[i__4737__auto___28676]));

var G__28677 = (i__4737__auto___28676 + (1));
i__4737__auto___28676 = G__28677;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28671){
var vec__28672 = p__28671;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28672,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28669){
var G__28670 = cljs.core.first.call(null,seq28669);
var seq28669__$1 = cljs.core.next.call(null,seq28669);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28670,seq28669__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28680__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28680__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28680__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28680__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28681 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28681,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28681,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28681,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28681,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28681,(4),null);
var arity = cljs.core.nth.call(null,vec__28681,(5),null);
...
}catch (e28685){var _e__27963__auto__ = e28685;
...
var G__28686 = (obj[cljs.core.first.call(null,path)]);
var G__28687 = cljs.core.rest.call(null,path);
obj = G__28686;
path = G__28687;
continue;
} else {
...
var _STAR_ = (function (accum,p__28688){
var vec__28689 = p__28688;
var bit = cljs.core.nth.call(null,vec__28689,(0),null);
var protocol = cljs.core.nth.call(null,vec__28689,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28692){
var vec__28693 = p__28692;
var ns = cljs.core.nth.call(null,vec__28693,(0),null);
var name = cljs.core.nth.call(null,vec__28693,(1),null);
var selector = cljs.core.nth.call(null,vec__28693,(2),null);
...
var post_process = (function (p__28697){
var vec__28698 = p__28697;
var munged_name = cljs.core.nth.call(null,vec__28698,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28698,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28696_SHARP_){
return (obj[cljs.core.first.call(null,p1__28696_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1590594092719
